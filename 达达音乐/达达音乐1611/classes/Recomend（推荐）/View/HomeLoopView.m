...
#define kIdentifier @"HomeLoopViewCellIdentifier"
#define kPageH 20
@interface HomeLoopView() <UIScrollViewDelegate>
...
- (void)addScrollView {
    ...
    for (int i = 0; i < 3; i++) {
        ...
        FocusResultModel *lm = self.currentImages[i];
        [imageView setImageWithURL:lm.randpic_iphone6];
